...
const Spline = dynamic(() => import('@splinetool/react-spline'), { 
  ssr: false,
  loading: () => <div className="absolute inset-0 flex items-center justify-center text-white/20 text-xs tracking-widest font-mono">INITIALIZING 3D ENGINE...</div>
});
  ...
  return (
    <section id="tech-stack" className="relative py-8 md:py-24 px-4 md:px-16 w-full z-10 overflow-hidden border-y border-white/[0.03] scroll-mt-20 bg-black">
      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="relative w-full max-w-[1200px] h-[300px] sm:h-[500px] md:h-[750px] flex items-center justify-center">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0 pointer-events-none flex items-center justify-center">
            <div className="absolute w-[350px] h-[350px] rounded-full bg-blue-500/5 blur-[140px] animate-pulse" />
            <div className="absolute w-[500px] h-[500px] md:w-[700px] md:h-[700px] rounded-full border border-white/5" />
            <div className="absolute w-[400px] h-[400px] md:w-[500px] md:h-[500px] rounded-full border border-white/5" />
          </div>

          {/* New Spline Scene - Forced Refresh */}
          <motion.div 
          ...
          >
             ...
             <div className="absolute bottom-0 right-0 w-[150px] h-[50px] bg-black z-20 pointer-events-auto" />
          </motion.div>
        </div>
